...
module.exports = {
  mode: 'development', 
  entry: './static/src/scripts/main.ts', // точка входа
  output: {
    filename: 'bundle.[contenthash].js',  // имя выходного файла
    path: path.resolve(__dirname, 'static/resource'), // путь для выходного файла
  ...
  plugins: [
    new HtmlWebpackPlugin({
      template: './static/src/index.html', // шаблон HTML
    }),
